...
<body>
    ...
    <div>
   <h3 class="sub_title"><span>전국 재활용센터 위치 안내</span></h3>
   </div>
    ...
    <script>
        var mapContainer = document.getElementById('map'), 
            mapOption = {
                center: new kakao.maps.LatLng(36.83916273518297, 127.18597773927601), 
                level: 6, 
        ...
        for (var i = 0; i < positionData.length; i++) {
            var marker = new kakao.maps.Marker({
                position: new kakao.maps.LatLng(positionData[i][0], positionData[i][1]),
                map: map 
            });
